...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			listItem += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + media.title + (media.artist ? " <span class='jp-artist'>feat. " + media.artist + "</span>" : "")+(media.producer? " <span class='jp-artist'>prod. "+media.producer+"</span>":"") + "</a>";
			listItem += "</div></li>";
